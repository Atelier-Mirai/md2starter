...
@<href>{https://github.blog/2022-05-19-math-support-in-markdown/,Markdown Math support}


//quote{
Mathematical expressions can now be rendered natively in Markdown on GitHub.

You can use the \@<m>{ and \}\$ delimiters natively in Markdown on GitHub to insert math expressions in TeX and LaTeX style syntax. 

For example, the following Markdown,

//}
500\@<m>{のパソコンと、300\}のパソコン
